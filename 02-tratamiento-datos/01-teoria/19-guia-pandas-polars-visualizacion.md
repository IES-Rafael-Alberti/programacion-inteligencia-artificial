# UD2 -- Módulo PIA (Bloques de Pandas, Polars y visualización) -- Actualización 2025 (Python 3.12.2, Pandas 2.3.3, Polars 1.34.0)
...
## Bloque 5: Pandas Avanzado y Introducción a Polars (modo *eager*)

En el bloque 5 exploraremos funcionalidades avanzadas de **Pandas** y
...
al final (modo que veremos en detalle en la bloque 6).

En este bloque nos centraremos en el modo *eager* para familiarizarnos
...
-- *veremos detalles en bloque 6*. Para archivos Parquet:
...
ejemplos están disponibles en el notebook de la bloque 5, listos para
ejecutarse:
...
## Bloque 6: Polars Avanzado (modo *lazy*), cuDF (GPU) y Visualización de Datos

En la bloque 6 nos adentraremos en las capacidades avanzadas de Polars,
...
**Comparativa visual R vs Python:** (Esto enlaza con bloque 7, pero
...
En los notebooks de la bloque 6, incluiremos ejercicios para generar
...
### Ejercicios Prácticos (Bloque 6)

Los notebooks de este bloque proponen ejercicios centrados en Polars
...
## Bloque 7: Fundamentos de R y Comparativa Python vs R

En la bloque 7 cambiaremos el enfoque para introducir los **fundamentos
...
notebooks de bloque 7 serán probablemente ilustrativos, mostrando
...
### Ejercicios Prácticos (Bloque 7)

Los ejercicios propuestos este bloque buscan que los alumnos reflexionen
...
A lo largo de estos bloques, hemos actualizado los materiales del
...
*eager* en bloque 5 y *lazy* en bloque 6, incluyendo comparativas de

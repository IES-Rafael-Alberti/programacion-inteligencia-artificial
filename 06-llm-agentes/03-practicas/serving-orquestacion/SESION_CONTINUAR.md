# Sesión compactada - Bloque de serving y orquestación
...
- `00-guia-serving-orquestacion.md`

### Paquetes generados

- `fase1-notebooks-base.zip`
- `fase1-soluciones.zip`
- `fase1-soluciones-tests.zip`
- `fase2-notebooks-base.zip`
- `fase2-soluciones.zip`
- `fase2-soluciones-tests.zip`
- `guias-serving-orquestacion.zip`

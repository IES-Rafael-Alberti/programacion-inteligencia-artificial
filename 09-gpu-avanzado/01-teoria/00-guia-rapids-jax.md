...
- **01_rapids_intro.ipynb** → Introducción a RAPIDS (cuDF y cuML).
- **02_jax_intro.ipynb** → Arrays y diferenciación automática con JAX.
- **03_gpu_benchmarks.ipynb** → Comparación de rendimiento entre NumPy, RAPIDS y JAX.

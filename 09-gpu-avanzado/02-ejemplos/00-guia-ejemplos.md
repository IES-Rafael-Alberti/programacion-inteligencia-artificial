# Bloque 04-06 – Agentes y Automatización
...
- **04_virtual_agent_intro.ipynb** → Agente conversacional con memoria.
- **05_prefect_intro.ipynb** → Flujo ETL simple con Prefect.
- **06_agent_api.ipynb** → Agente que consulta una API externa.

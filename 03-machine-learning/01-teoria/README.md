# Teoría UD3 — Machine Learning

Documentación de apoyo para la unidad de Machine Learning con scikit-learn y CuML.

## Ruta recomendada

| Orden | Tema | Material |
|-------|------|----------|
| 00 | Índice general ML scikit-learn / CuML | `00-indice-ml-scikit-cuml.md` |
| 01 | Capítulo I — Introducción al ML | `01-ml-scikit-cuml-capitulo-i.md` |
| 02 | Capítulo II — Modelos y evaluación | `02-ml-scikit-cuml-capitulo-ii.md` |

...
Unidad introductoria que cubre los fundamentos de programación en Python orientados al análisis de datos e IA. Trabaja los RA/CE iniciales del módulo: sintaxis básica, estructuras de datos, control de flujo, funciones, y computación numérica con NumPy/JAX. Incluye también una introducción a R como lenguaje complementario.
...
- Pendiente: integrar rúbricas y cuestionarios GIFT

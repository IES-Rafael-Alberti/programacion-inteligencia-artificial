"""
Ejemplo 3 Mamba: Clasificación de Intenciones (Encoder-Only)
===========================================================

Arquitectura: Mamba Encoder
Datos: mini_clasificacion_intenciones.tsv

Este ejemplo demuestra cómo usar Mamba para clasificación,
usando solo el encoder (como BERT pero con Mamba).
...
from mamba_blocks import MambaEncoderClassifier


DATA_PATH = Path(__file__).resolve().parent.parent / "datos" / "mini_clasificacion_intenciones.tsv"
MODEL_PATH = Path(__file__).resolve().parent.parent / "modelos_mamba" / "mamba_clasificacion_intenciones.pt"

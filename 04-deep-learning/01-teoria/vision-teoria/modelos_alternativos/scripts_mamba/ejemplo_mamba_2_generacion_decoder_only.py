"""
Ejemplo 2 Mamba: Generación de texto estilo Quijote (Decoder-Only)
==================================================================

Arquitectura: Mamba Decoder-Only
Datos: mini_estilo_quijote.txt

Este ejemplo demuestra cómo usar Mamba para generación de texto,
usando solo el decoder (como GPT pero con Mamba).
"""
...
from mamba_blocks import MambaDecoderOnly


DATA_PATH = Path(__file__).resolve().parent.parent / "datos" / "mini_estilo_quijote.txt"
MODEL_PATH = Path(__file__).resolve().parent.parent / "modelos_mamba" / "mamba_generacion_quijote.pt"

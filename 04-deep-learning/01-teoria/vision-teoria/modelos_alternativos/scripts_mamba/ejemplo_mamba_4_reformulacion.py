"""
Ejemplo 4 Mamba: Reformulación con Sinónimos (Seq2Seq)
=======================================================

Arquitectura: Mamba Encoder-Decoder
Datos: mini_reformulacion_es.tsv

Este ejemplo demuestra cómo usar Mamba para reformular frases,
...
MODEL_PATH = Path(__file__).resolve().parent.parent / "modelos_mamba" / "mamba_reformulacion_es.pt"

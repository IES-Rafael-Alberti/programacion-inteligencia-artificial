"""
Ejemplo 1 Mamba: Seq2Seq Traducción Inglés -> Español
=====================================================

Arquitectura: Mamba Encoder-Decoder
Datos: mini_trad_es_en_ampliado.tsv ( invertimos para EN->ES )

Este ejemplo demuestra cómo usar Mamba para tareas seq2seq,
comparándolo con el Transformer tradicional.
"""
...
from mamba_blocks import MambaSeq2Seq


DATA_PATH = Path(__file__).resolve().parent.parent / "datos" / "mini_trad_es_en_ampliado.tsv"
MODEL_PATH = Path(__file__).resolve().parent.parent / "modelos_mamba" / "mamba_traduccion_en_es.pt"
